...
public static class Tools
{
    ...
    public static async Task<string> Search(
        HttpClient client,
        [Description("The Jira Query Language."), Required] string jql,
        [Description("The index of the first issue to return (pagination). Optional.")] int? startAt = 0,
        [Description("The maximum number of issues to return (pagination). Optional. Min 1, Max 1000. Default 10. When there is a request to get the total count or number of tickets, use 1000 for maxResults.")] int? maxResults = 10,
